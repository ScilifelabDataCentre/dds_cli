...
apt-get update
apt-get install -y make gcc librsvg2-bin texlive-latex-extra texlive-xetex texlive-fonts-recommended fonts-noto-color-emoji texlive-latex-recommended latexmk fonts-freefont-ttf

...
IMPORTANT_INFORMATION_MESSAGES = [
    {
        ...
        "Message": (
            "Important! Data download on Dardel: For data downloads on Dardel, "
            "please log into the dedicated file transfer node: dardel-ftn01.pdc.kth.se. "
            "Do NOT submit data-transfer jobs to the queueing system, run them directly on that node."
        ),
    },
    {
        "Created": "2025-02-07 11:13",

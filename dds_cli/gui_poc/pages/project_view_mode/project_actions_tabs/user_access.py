...
from dds_cli.gui_poc.components.dds_container import DDSSpacedContainer, DDSSpacedHorizontalContainer
...
class UserAccess(Widget):
    ...
    def compose(self) -> ComposeResult:
        with DDSSpacedContainer(id="user-access-container"):
            yield DDSTextItem("Manage user access by inviting users, revoke access, or re-granting access to projects.")
